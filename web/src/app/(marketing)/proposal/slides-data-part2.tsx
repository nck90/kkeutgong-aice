import { PlanCalendarMockup, TextbookMockup, LabsIDEMockup } from './ui-mockups';
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center w-full">
          ...
          <div className="flex-1 w-full text-left">
            ...
            <div className="flex flex-col gap-6 text-xl text-muted-foreground leading-[1.8] max-w-2xl">
              <p>
                더 이상 엑셀로 계획을 짜느라 시간을 낭비하지 마세요. 사용자의 목표 트랙과 시험일(D-Day)을 설정하면 시스템이 지시하는 대로 따르기만 하면 됩니다.
              </p>
          ...
          <div className="flex-[1.2] w-full max-w-3xl">
            <PlanCalendarMockup className="h-[600px] text-left" />
          </div>
        </div>
      </div>
    ),
      ...
      <div className="flex flex-col justify-center h-full w-full px-12 md:px-24 max-w-[1700px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-center w-full">
          ...
          <div className="flex-1 w-full text-left">
            ...
            <div className="flex flex-col gap-6 text-xl text-muted-foreground leading-[1.8] max-w-2xl">
              <p>
                수백 페이지의 무거운 파이썬 문법책을 다 볼 필요가 없습니다. 실전 시험에서는 쓰는 문법만 씁니다.
              </p>
              <p>
          ...
          {/* Right Visual */}
          <div className="flex-[1.2] w-full max-w-3xl">
            <TextbookMockup className="h-[600px] text-left" />
          </div>
        </div>
      </div>
    ),
      ...
      <div className="flex flex-col justify-center h-full w-full px-12 md:px-24 max-w-[1700px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-center w-full">
          ...
          <div className="flex-1 w-full text-left">
            ...
            <div className="flex flex-col gap-6 text-xl text-muted-foreground leading-[1.8] max-w-2xl">
              <p>
                개념을 암기했다면 이제 손이 기억할 차례입니다. 뷰어 옆에 AICE 실전 CBT 환경과 <b>동일한 서버리스 Jupyter 커널</b>이 터미널과 함께 브라우저에서 즉각 열립니다.
              </p>
          ...
          {/* Right Visual */}
          <div className="flex-[1.2] w-full max-w-3xl">
            <LabsIDEMockup className="h-[600px] text-left" />
          </div>
        </div>
      </div>
    ),
